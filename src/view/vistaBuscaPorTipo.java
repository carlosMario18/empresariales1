...
public class vistaBuscaPorTipo extends javax.swing.JFrame {
     ...
     * Creates new form vistaBuscaPorTipo
     */
    public vistaBuscaPorTipo() {
    ...
    private void btnConsultorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        vistaBuscarConsultorio vistaBuscarConsultorio = new vistaBuscarConsultorio();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaBuscaPorTipo().setVisible(true);
            }
        });
    }
